        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 10),
              GestureDetector(
                onTap: () => _selectDate('registrationDate'),
                child: AbsorbPointer(
                  child: TextField(
                    decoration: const InputDecoration(
                        labelText: "Registration Date",
                        border: OutlineInputBorder()),
                    controller: TextEditingController(text: formState['registrationDate']),
                  ),
                ),
              ),
              const SizedBox(height: 10),
              ...
              const SizedBox(height: 20),
              CustomButton(text: "Add Member", onClick: _handleSave),
            ],
          ),
        ),
      ),
